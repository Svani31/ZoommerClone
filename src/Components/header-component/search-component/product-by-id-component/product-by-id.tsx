        ...
        <Box className="product__item">
          ...
          <Box className="product__info">
            <Box className="product__title">
              ...
              <Typography
                onClick={() => compareHandler(item?.id)}
            ...
            <Typography variant="subtitle1">
              მეხსიერება:{Number(storageValue)}GB
            </Typography>
            <Box className="storage__side">
              <Button
                className={storageValue === "128" ? "active" : ""}
                onClick={(e) => getData(e)}
                data-storage="128"
              >
                128GB
              ...
              <Button
                className={storageValue === "256" ? "active" : ""}
                onClick={(e) => getData(e)}
                data-storage="256"
              >
                256GB
              ...
              <Button
                className={storageValue === "512" ? "active" : ""}
                onClick={(e) => getData(e)}
                data-storage="512"
              >
                512GB
              ...
              <Button
                className={storageValue === "1000" ? "active" : ""}
                onClick={(e) => getData(e)}
                data-storage="1000"
              >
                1TB
